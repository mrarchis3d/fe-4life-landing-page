...
const Card: React.FC<Product> = ({
  ...
  return (
    <div className="duration-200 hover:border-opacity-0 hover:no-underline hover:shadow-lg dark:hover:bg-white dark:hover:bg-opacity-10">
      <div className="link-card flex p-1 bg-white">
        <div className="p-4 text-center">
          <a href={`productos/${id}`}>
            <img className="m-auto rounded-2xl" src={image} alt={image} />
            <h1 className="md:text-md">
              <strong>{name}</strong>
            </h1>
          </a>

          <SeeMore body={shortDescription} />
          <br />
          <br />
          <div className="block">
